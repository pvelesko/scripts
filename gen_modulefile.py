...
module.append(f"pushenv {package_name}_PATH $install_dir/bin")
module.append(f"pushenv {package_name}_ROOT $install_dir/bin")
module.append(f"pushenv {package_name}_DIR $install_dir/bin")
module.append(f"pushenv {package_name_upper}_PATH $install_dir/bin")
module.append(f"pushenv {package_name_upper}_ROOT $install_dir/bin")
module.append(f"pushenv {package_name_upper}_DIR $install_dir/bin")
module.append("")
